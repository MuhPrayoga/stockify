            ...
            <ul class="space-y-2">
                ...
                <li>
                    <a href="/admin/products"
                       class="flex items-center px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200 hover:bg-slate-800 hover:text-white group">
                        <i class="fas fa-boxes mr-3 text-slate-400 group-hover:text-indigo-400 transition"></i>
                        Products
                    </a>
                </li>
                ...
                <li>
                    <a href="/admin/suppliers"
                       class="flex items-center px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200 hover:bg-slate-800 hover:text-white group">
                        <i class="fas fa-truck mr-3 text-slate-400 group-hover:text-indigo-400 transition"></i>
                        Suppliers
                    </a>
                </li>
                ...
                <li>
                    <a href="/admin/users"
                       class="flex items-center px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200 hover:bg-slate-800 hover:text-white group">
                        <i class="fas fa-users mr-3 text-slate-400 group-hover:text-indigo-400 transition"></i>
                        Users
                    </a>
                </li>

                <li class="pt-4 border-t border-slate-800"></li>

                <li>
                    <a href="/admin/reports"
                       class="flex items-center px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200 hover:bg-slate-800 hover:text-white group">
                        <i class="fas fa-chart-bar mr-3 text-slate-400 group-hover:text-indigo-400 transition"></i>
                        Reports
                    </a>
                </li>
                ...
                <li>
                    <a href="/admin/settings"
                       class="flex items-center px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200 hover:bg-slate-800 hover:text-white group">
                        <i class="fas fa-cogs mr-3 text-slate-400 group-hover:text-indigo-400 transition"></i>
                        Settings
                    </a>
                </li>
